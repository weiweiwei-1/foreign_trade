package pers.kingvi.foreigntrade.util.fa.error;

public class FaVoErrorUtils {
    ...
    public static final String COMPANY_LINK_ERROR = "链接字符小于130个";
    ...
    public static final String MAIN_BUSINESS_SCOPE_ERROR = "字数小于60个";
    public static final String SERVICE_ADVANTAGE_ERROR = "字数小于60个";
