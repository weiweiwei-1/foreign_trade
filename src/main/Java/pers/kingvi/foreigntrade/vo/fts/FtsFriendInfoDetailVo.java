...
public class FtsFriendInfoDetailVo {
    ...
    public FtsFriendInfoDetailVo() {

    }

    public FtsFriendInfoDetailVo(Long id, String photo, String name, String reMark, String city, String company, String companyLink, String sex, Integer age, Integer workingTime, String mainBussinessScope, String serviceAdvantage, String weChat, String phone, String email) {
        this.id = id;
        this.photo = photo;
        this.name = name;
        this.reMark = reMark;
