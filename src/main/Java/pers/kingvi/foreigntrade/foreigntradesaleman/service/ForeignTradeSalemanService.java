...
public interface ForeignTradeSalemanService {
    ...
    PageBeanVo<ForeignTradeSaleman> selectByParam(String condition, String text, Integer currentPage, Integer perPageRecord);      //好友查询页面
    ...
    PageBeanVo<ForeignTradeSaleman> selectFullIndex(String text, Integer currentPage, Integer perPageRecord);    // 全文索引页面
